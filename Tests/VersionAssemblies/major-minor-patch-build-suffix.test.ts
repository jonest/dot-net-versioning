...
let versionPattern: string = "major-minor-patch-build";

let originalVersionNumber: string = "1.0.0.0";
let versionNumber: string = "7.20.1969.176";
let versionSuffix: string = "-dev";
